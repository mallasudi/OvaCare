...
import { upsertDailyLog, getDailyLogs, getSymptomInsights, getJournalHistory, createOrUpdateDailyLog, getTodayLog, deleteJournalEntry, getDailyLogAnalytics } from "../controllers/dailyLogController.js";
...
router.get("/analytics", authMiddleware, getDailyLogAnalytics); // must be before GET /
