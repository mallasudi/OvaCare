          ...
          <div className="relative mt-5 flex flex-wrap gap-2">
            {latestReport && (
              <button
                ...
                className="bg-white/20 hover:bg-white/30 backdrop-blur text-white font-semibold px-5 py-2.5 rounded-full text-sm transition-all border border-white/30 hover:scale-105"
              >
                View Full Report →
              </button>
            )}
            ...
            >
              {latestReport ? "Retake Assessment" : "Take Assessment"}
            </button>
          </div>
